...
export default function Logo(props: GroupProps & { scale: [number, number, number] }) {
  ...
  useFrame(() => {
    ...
    ref.current.scale.y = (1 + offset) * props.scale[1];
    ref.current.scale.z = (1 + offset) * props.scale[2];
  });
